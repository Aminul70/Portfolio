...
// ... (TerminalQuote and AnimatedCopyright components stay the same)
...
export function Portfolio() {
  ...
  useEffect(() => {
    ...
    heroImage.src = '/pixelcut-export_(1).jpg';

    const minLoadTime = 2000; // Minimum 2 seconds for the animation to be seen
    ...
    if (heroImage.complete) {
      ...
      heroImage.onerror = handleLoad; // Fallback so we don't get stuck
    }
  ...
  if (!content) return <SpiralLoader />;
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#001233] text-white selection:bg-cyan-500/30">
