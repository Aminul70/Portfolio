...
export function FooterEditor() {
  ...
  return <div className="space-y-8">
      <div className="flex items-center justify-between">
        <h2 className="text-2xl font-black text-white">Footer Content</h2>
      ...
      <div className="bg-white/5 border border-white/10 rounded-2xl p-8 space-y-6 backdrop-blur-sm">
        <div className="space-y-2">
          ...
          <input type="text" value={content.footer.terminalQuote} onChange={e => setContent({
          ...content,
          footer: {
            ...content.footer,
            terminalQuote: e.target.value
          }
        ...
        <div className="space-y-2">
          ...
          <input type="text" value={content.footer.copyrightText} onChange={e => setContent({
          ...content,
          footer: {
            ...content.footer,
