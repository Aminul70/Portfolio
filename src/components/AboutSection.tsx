    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-[1fr_1.3fr] gap-6 md:gap-8">
      ...
      <motion.div initial={{
        ...
        <div className="relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-6 md:p-8 overflow-hidden hover:border-cyan-500/30 transition-all duration-500">
          ...
          <div className="relative block group/photo">
            <div className="absolute inset-0 rounded-2xl blur-2xl opacity-20 bg-cyan-500 group-hover/photo:opacity-40 transition-opacity duration-500" />
            <div className="relative aspect-[3/4] rounded-2xl overflow-hidden border-2 border-cyan-500/30 group-hover/photo:border-cyan-500/60 transition-colors duration-500">
              <img src="/a-cinematic-portrait-photograph-of-a-you_Udra-uIpRLWJIwzQIfDkig_VXiqu_E3RPqmpJfNUNNUCg.jpg" alt="MD Aminul Islam - Professional Portrait" className="w-full h-full object-cover transition-transform duration-700 group-hover/photo:scale-105" />
        ...
        <div className="relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-6 md:p-8 h-full hover:border-cyan-500/30 transition-all duration-500">
          ...
          <div className="relative z-10 space-y-6">
            ...
            <div className="space-y-4 text-base text-gray-300 leading-relaxed">
              <p>
                Hi, I'm{' '}
                <LinkPreview url="https://www.facebook.com/aminul.ethos" imageSrc="/a-cinematic-portrait-photograph-of-a-you_Udra-uIpRLWJIwzQIfDkig_VXiqu_E3RPqmpJfNUNNUCg.jpg" width={150} height={100} className="font-semibold text-white hover:text-cyan-400 transition-colors">
                  MD Aminul Islam
                </LinkPreview>
